              ...
              {step.id < currentStep ? (
                <div className="group flex items-center">
                  ...
                  {stepIdx !== steps.length - 1 ? (
                    <div className="absolute right-0 top-4 hidden h-0.5 w-full bg-green-600 lg:block" />
                  ) : null}
                </div>
              ) : step.id === currentStep ? (
                <div className="flex items-center" aria-current="step">
                  ...
                  {stepIdx !== steps.length - 1 ? (
                    <div className="absolute right-0 top-4 hidden h-0.5 w-full bg-gray-200 lg:block" />
                  ) : null}
                </div>
              ) : (
                <div className="group flex items-center">
