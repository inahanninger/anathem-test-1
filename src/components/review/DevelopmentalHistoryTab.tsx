      ...
      <div className="flex-1">
        <ScrollArea className="h-[calc(100vh-220px)]">
          <div className="space-y-6">
            <div id="dev-1">
              <h3 className="text-sm font-semibold mb-2">Demographic & Background Information</h3>
              <EditableField 
                initialValue={demographicInfo} 
                fieldType="textarea" 
                onSave={(value) => {
