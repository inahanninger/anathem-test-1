...
const TabsHeader = ({
  ...
  return <>
      <div className="flex items-center mb-2">
        <Button variant="outline" size="sm" onClick={() => setShowGenerateModal(true)} className="h-9 gap-1 border-gray-200 text-gray-700 mr-4 bg-neutral-200 hover:bg-neutral-100">
