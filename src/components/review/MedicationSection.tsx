...
const MedicationSection = ({
  ...
  return <div className="pb-4 space-y-3 px-0">
      {medications.map(med => <MedicationItem key={med.id} medication={med} onUpdate={onUpdate} onDelete={onDelete} alwaysEditable={true} />)}
