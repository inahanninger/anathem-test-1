  ...
  return <ClinicalLayout>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          {selectedFile && <div className="py-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Button variant={selectedFile.type === "transcript" ? "default" : "outline"} className="justify-start" onClick={() => handleUpdateFileType("transcript")}>
                      Transcript
                    </Button>
                    <Button variant={selectedFile.type === "dictation" ? "default" : "outline"} className="justify-start" onClick={() => handleUpdateFileType("dictation")}>
                      Dictation
                    </Button>
                    <Button variant={selectedFile.type === "letter" ? "default" : "outline"} className="justify-start" onClick={() => handleUpdateFileType("letter")}>
                      Letter
                    </Button>
                    <Button variant={selectedFile.type === "patient notes" ? "default" : "outline"} className="justify-start" onClick={() => handleUpdateFileType("patient notes")}>
                      Patient Notes
                    </Button>
                  </div>
                </div>
